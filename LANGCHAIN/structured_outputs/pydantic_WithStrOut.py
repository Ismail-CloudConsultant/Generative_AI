...
## THIS IS MORE POWERFUL AS IT DOES THE VALIDATION AND SETS THE OPTIONAL AND DEFAULTS VALUES 

class Review(BaseModel):
    key_themes:list[str]= Field(description="Write down all the key themes discussed in the review in a list")
    summary: str= Field(description="A breif summary of the review")
    sentiment:Literal["Negative", "Postive" ,"Neutral"]=Field(description="returns sentiment IN Negative, Postive ,Neutral")
